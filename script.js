...
//Code that checks if the length is between 8 and 128 characters. Does not continue code if input is invalid. Last conditional should catch any non-numerical inputs, but doesn't work right now.
